...
?>
    ...
    <script src="https://upiitascholar.com/js/MapaRealista.js"></script>
    <script>
        let mapaRealista;
        let rutaActual = null;
        ...
        async function buscarLugares() {
            ...
            try {
                const response = await fetch(`https://upiitascholar.com/api/buscar_lugares.php?q=${encodeURIComponent(termino)}`);
                const data = await response.json();
...
<script src="https://upiitascholar.com/js/corregir_rutas_ajax.js"></script>
